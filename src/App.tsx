...
import { usePropertyViewModel, SortOption } from './viewmodels/usePropertyViewModel';
...
import { Filter, Search, Building2, Loader2 } from 'lucide-react';
      ...
      <header className="sticky top-0 z-40 w-full bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-[1600px] mx-auto px-4 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.location.reload()}>
            ...
            <div>
              <h1 className="text-xl font-bold tracking-tighter uppercase leading-none">LuxeLoft</h1>
              <p className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] mt-1 font-medium">Premier Real Estate</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <Sheet>
              <SheetTrigger render={
                <Button variant="outline" size="sm" className="md:hidden rounded-none border-gray-200">
        ...
        <main className="flex-1 p-6 md:p-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-light tracking-tight">
                Available <span className="font-serif italic">Residences</span>
              </h2>
            </div>
          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center py-40 gap-4">
              ...
              <p className="text-sm font-medium text-gray-400 uppercase tracking-widest">Updating Catalog...</p>
            </div>
          ) : (
            <AnimatePresence mode="popLayout">
              {properties.length > 0 ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-medium mb-2">No properties match your criteria</h3>
                  <p className="text-muted-foreground max-w-md mx-auto mb-8">
                    Try adjusting your filters or searching for a different neighborhood to find your dream loft.
                  </p>
                  <Button onClick={resetFilters} variant="outline" className="rounded-none border-black hover:bg-black hover:text-white transition-all">
                    Clear All Filters
                  </Button>
                </motion.div>
              )}
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h1 className="text-lg font-bold tracking-tighter uppercase">LuxeLoft</h1>
            </div>
            <p className="text-muted-foreground max-w-sm text-sm leading-relaxed">
              The premier destination for luxury urban living. We curate the finest lofts, apartments, and penthouses for the discerning modern professional.
            </p>
          </div>
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest mb-6">Explore</h4>
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-black transition-colors">Downtown Lofts</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Heights Penthouses</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Harbor Flats</a></li>
              <li><a href="#" className="hover:text-black transition-colors">Arts District Studios</a></li>
            </ul>
          </div>
          <div>
